    ...
    // Replace these placeholder links with the actual Google Drive shareable URLs for each file.
    const PDF_DRIVE_LINKS = {
      // 2025 Cohort Papers
      "2025_Day_1_Rewrite_v1_IntroductionToAgents.pdf": "https://drive.google.com/file/d/YOUR_2025_DAY1_DRIVE_ID/view?usp=sharing",
      "2025_Day_2_Rewrite_v1_AgentTools.pdf": "https://drive.google.com/file/d/YOUR_2025_DAY2_DRIVE_ID/view?usp=sharing",
      "2025_Day_3_Rewrite_v1_ContextEngineering.pdf": "https://drive.google.com/file/d/YOUR_2025_DAY3_DRIVE_ID/view?usp=sharing",
      "2025_Day_4_Rewrite_v1_AgentQuality.pdf": "https://drive.google.com/file/d/YOUR_2025_DAY4_DRIVE_ID/view?usp=sharing",
      "2025_Day_5_Rewrite_v1_Prototype.pdf": "https://drive.google.com/file/d/YOUR_2025_DAY5_DRIVE_ID/view?usp=sharing",

      // 2026 Cohort Papers
      "Day_1_v3.pdf": "https://drive.google.com/file/d/YOUR_2026_DAY1_DRIVE_ID/view?usp=sharing",
      "Agent Tools & Interoperability_Day_2.pdf": "https://drive.google.com/file/d/YOUR_2026_DAY2_DRIVE_ID/view?usp=sharing",
      "Agent Skills_Day_3.pdf": "https://drive.google.com/file/d/YOUR_2026_DAY3_DRIVE_ID/view?usp=sharing",
      "Vibe Coding Agent Security and Evaluation_Day_4.pdf": "https://drive.google.com/file/d/YOUR_2026_DAY4_DRIVE_ID/view?usp=sharing",
      "Day_5_v3.pdf": "https://drive.google.com/file/d/YOUR_2026_DAY5_DRIVE_ID/view?usp=sharing"
    };

    // Helper to resolve local PDF path to Google Drive link if available
    function resolvePdfLink(localPath) {
      if (!localPath) return "#";
      const filename = localPath.split('/').pop();
      if (PDF_DRIVE_LINKS[filename] && !PDF_DRIVE_LINKS[filename].includes("YOUR_")) {
        return PDF_DRIVE_LINKS[filename];
      }
      return localPath; // Fallback to local file path
    }
